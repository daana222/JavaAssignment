 ...
 * @author HP
 */
public class View_inventory_reports extends javax.swing.JFrame {

    /**
     * Creates new form View_inventory_reports
     */
    public View_inventory_reports() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("    VIEW INVENTORY REPORTS    ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_inventory_reports.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new View_inventory_reports().setVisible(true);
            }
        });
    }
